...
const categories = {
    ...
    music: {
        ...
        fields: [
            { name: '`!!play <url/search>`', value: '▸ เล่นเพลงจาก YouTube', inline: false },
    ...
    admin: {
        ...
        fields: [
            { name: '`!!purge <จำนวน>`', value: '▸ ลบข้อความ (1-100)', inline: false },
    ...
    general: {
        ...
        fields: [
            { name: '`!!help`', value: '▸ แสดงเมนูนี้', inline: true }
        ]
    }
};
...
function createComponents(currentCategory) {
    const selectMenu = new StringSelectMenuBuilder()
        ...
        .addOptions([
            { label: 'หน้าหลัก', description: 'กลับไปหน้าหลัก', emoji: '🏠', value: 'home', default: currentCategory === 'home' },
            { label: 'Music', description: 'คำสั่งเกี่ยวกับเพลง', emoji: '🎵', value: 'music', default: currentCategory === 'music' },
            { label: 'Admin', description: 'คำสั่งสำหรับแอดมิน', emoji: '🛠️', value: 'admin', default: currentCategory === 'admin' },
            { label: 'General', description: 'คำสั่งทั่วไป', emoji: '📋', value: 'general', default: currentCategory === 'general' }
        ]);
